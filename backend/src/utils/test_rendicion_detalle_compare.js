// test_rendicion_detalle_compare.js
const { buildRendicionDetalle } = require('./cigGenerator');

// Línea real de rendición de pagos (ejemplo proporcionado)
const lineaReal =
  'DCUIT30715312405    30715312405       PC                                                             00202510201583263702099N00000000664980003041012020251110000000006649800007N                          07T.AUTOSERV.C/R000000000                                                                        .';
